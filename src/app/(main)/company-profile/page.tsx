              ...
              <CardContent className="px-0 space-y-6">
                <div className="space-y-2 group">
                  ...
                  <Textarea
                    ...
                    className="min-h-[120px] text-base border-none bg-muted/30 focus-visible:bg-background focus-visible:ring-1 transition-all resize-none p-4 rounded-xl"
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2 group">
                      ...
                      <Input
                        ...
                        className="border-none bg-muted/30 focus-visible:bg-background focus-visible:ring-1 h-12 px-4 rounded-xl font-medium"
                        disabled={!canEdit}
                      />
                    </div>
                    <div className="space-y-2 group">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2 group">
                      ...
                      <Select
                        ...
                        disabled={!canEdit}
                      >
                        <SelectTrigger className="border-none bg-muted/30 focus:bg-background focus:ring-1 h-12 px-4 rounded-xl font-medium">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
            ...
            <Card className="rounded-2xl border bg-muted/20 shadow-none">
              <CardHeader>
                <CardTitle className="text-lg flex items-center gap-2">
                  <Globe className="h-4 w-4" /> Presence & Logo
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-2 group">
                  ...
                  <Input
                    ...
                    className="border-none bg-background focus-visible:ring-1 h-10 px-3 rounded-lg text-sm"
                    placeholder="https://..."
                    disabled={!canEdit}
                  />
                </div>
                ...
                <div className="space-y-2 group">
                  ...
                  <Textarea
                    ...
                    className="border-none bg-background focus-visible:ring-1 min-h-[80px] px-3 rounded-lg text-sm resize-none"
                    disabled={!canEdit}
                  />
                </div>
